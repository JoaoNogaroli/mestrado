...
def acumulado_piotroski(ano):
    pa_th = f'Disciplina-atellier/mestrado/plotagem_streamlit/acumulados_piotroski/acumulado/acumulado_{ano}.csv'
    return pd.read_csv(pa_th)

@st.cache_data
def acumulado_piotroski_f(ano):
    pa_th = f'Disciplina-atellier/mestrado/plotagem_streamlit/acumulados_piotroski/acumulado_f/acumulado_{ano+1}.csv'
    return pd.read_csv(pa_th)
